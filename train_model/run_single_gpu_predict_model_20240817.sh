...
# 与批量运行无关的参数
ROOT_BASE_DIR=/home/zhuxiang001/MedQA_Train/
EVAL_BATCH_SIZE=1
...
# 微调的模型路径
ADAPTER_NAME_OR_PATH=/home/zhuxiang001/MedQA_Train/saves/fdm_on_RAG_MedQA_Mainland_train_500/llama3-8b/lora/sft_with_epochs_2_lora_rank_1_lr_0.0001_lr_scheduler_cosine/checkpoint-500

# Meta-Llama-3-8B-Instruct
# Qwen1.5-14B-Chat

MODEL_NAME_OR_PATH=/home/zhuxiang001/llamafactory/Meta-Llama-3-8B-Instruct/
...
# 结果保存路径
RESULT_BASE_SAVE_DIR=/home/zhuxiang001/MedQA_Train/results2
