...
# File: run_single_gpu_train_model.sh
# Description: 
...
# CUDA_VISIBLE_DEVICES=7 ./run_single_gpu_train_model.sh 8 0.0001
...
RESULT_BASE_SAVE_DIR=${ROOT_BASE_DIR}/saves/jiyichat_on_${DATASET}/qwen1.5-14b/lora
NUM_TRAIN_EPOCHS=3
